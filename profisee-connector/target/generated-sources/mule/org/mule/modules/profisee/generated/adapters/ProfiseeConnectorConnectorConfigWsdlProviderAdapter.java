...
/**
 * A <code>ProfiseeConnectorConnectorConfigWsdlProviderAdapter</code> is a wrapper around {@link ProfiseeConnector } that represents the WSDL generic connector {@link ConnectorConfig }
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-10-03T02:01:25-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class ProfiseeConnectorConnectorConfigWsdlProviderAdapter implements ProcessAdapter<WsdlAdapter> , Disposable, ConnectorMetaDataEnabled, WsdlAdapter
{

    private WSResolver wsResolver;
    private ConnectorConfig config;
    protected ProfiseeConnectorProcessAdapter connector;
    ...
    {
        if (connector == null) {
            connector = new ProfiseeConnectorProcessAdapter();
     ...
     * 
     */
    public ProfiseeConnectorProcessAdapter getConnector() {
        if (connector == null) {
            try {
